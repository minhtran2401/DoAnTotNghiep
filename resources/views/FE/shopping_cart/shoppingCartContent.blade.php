...
<div class="top-banner background-top-banner-for-shopping min-height-346px">
    <h3 class="title">Giảm 25%</h3>
    <p class="subtitle">Áp dụng cho khách mua hàng lần đầu tại cửa hàng !!</p>
    <ul class="list">
        <li>
        ...
        <li>
            <div class="price-less">
                <span class="desc">Áp dụng mã giảm <b><i> NEWGF </i></b></span>
    ...
    <p class="btns">
    <a href="{{route('dang-ki')}}" class="btn">Mở tài khoản</a>
        <a href="#" class="btn">Xem thêm</a>
    </p>
</div>

<!--Cart Table-->
<div class="shopping-cart-container" id="change-item-list-cart">
    <div class="row">
