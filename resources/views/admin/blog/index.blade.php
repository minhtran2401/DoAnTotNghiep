...
@section('pagetitle', 'QUẢN LÍ BLOG ')
@section('main')
    @include('admin/blog/loopblog')
@endsection
@section('jsc')
...
$("#table-1").on("click", ".change-noibat", function(e){
// $(document).ready(function(){
  $('.change-noibat').change(function(e){
      // ngăn sự kiện change-status này khi click sẽ lan ra các sự kiện khác
      //thường áp dụng cho các button form hoặc thẻ link ( tag a )
        e.preventDefault();

        //lấy id nhóm sản phẩm từ thẻ td ( data-id )
        var id=$(this).parent().parent().data('noibat');
